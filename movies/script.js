const movies = [
      ...
      movies.forEach(movie => {
          ...
          li.innerHTML = `
              ...
              <div>
                  ...
                  <button onclick="addToFavorites('${movie.title}', '${movie.release_date}')">Add to Favorites</button>
              </div>
          `;
  ...
  function addToFavorites(title, release_date) {
      const favoriteItems = Array.from(favoritesList.querySelectorAll('li'));
      const isAlreadyFavorite = favoriteItems.some(item => item.querySelector('.task-text').textContent === title);
      ...
      li.innerHTML = `
          <div>
              ...
              <span class="status">Release Date: ${release_date}</span>
              <button onclick="removeFromFavorites(this)">Delete from Favorites</button>
          </div>
      `;
